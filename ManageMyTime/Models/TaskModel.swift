           ...
           do {
                ...
                if(!result.isEmpty)
                {
                    ...
                    let settingsObject=SettingsEntity(context: managedContext)
                        ...
                        if let entity = NSEntityDescription.entity(forEntityName: "SettingsEntity", in: managedContext) {
                            print("Class name registered:", entity.managedObjectClassName ?? "nil")
                        }
                       print("Runtime class:", type(of: settingsObject))
                       settingsObject.scheduleAlgorithm=scheduleAlgorithm.smart.rawValue
                       settingsObject.scheduleDensity=scheduleDensity.mediumDensity.rawValue
                       settingsObject.breakPeriods=breakPeriods.hourAndAHalf.rawValue
                       settingsObject.animationStyle=animationStyle.spring.rawValue
          ...
          do {
               ...
               if(!result.isEmpty)
               {
                ...
                let retrivedObject = result[0] as! NSManagedObject
                    ...
                    retrivedObject.setValue(scheduleAlgorithim, forKey: "scheduleAlgorithm")

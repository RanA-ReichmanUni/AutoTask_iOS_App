...
struct UpdateTask: View {
   ...
   // @State var selectedDate:Date
    ...
    @State var selectedColorIndex:Color
                        ...
                        Button(action: {
                            ...
                            if(self.disableSave)
                            {
                              ...
                              self.mode.wrappedValue.dismiss()
                                ...
                                Text(" Update ").frame(width:100,height:55).foregroundColor(Color.white).background(RoundedRectangle(cornerRadius: 5).fill(self.disableSave ? Color.gray : Color.blue).frame(width:100,height:55)).padding(.bottom,20)

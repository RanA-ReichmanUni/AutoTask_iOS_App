...
class Core{
  ...
  /*  func scheduleHandler(taskName:String,importance:String,asstimatedWorkTime:Hour,dueDate:Date,notes:String,color:String,scheduleSection:String) throws
    ...
    func SchedulingPriorityAlgrorithmDates(startDate:CustomDate,endDate:CustomDate) throws -> [CustomDate]
    {
        ...
        let schedulingAlgorithm = ScheduleAlgorithmEnumConverter(phrase:taskModel.getSettingsValues().scheduleAlgorithm)
              ...
              catch
              {
                ...
                if(loadLevels.isEmpty)
                {
                   ...
                   let loadLevel=LoadLevel(context: managedContext)
                    loadLevel.date=date
                    loadLevel.loadLevel=Float(CGFloat(duration.hourInMinutes())/CGFloat((endOfTheDay-startOfTheDay)*60))
                    ...
                    loadLevels[0].loadLevel = Float(loadLevels[0].loadLevel)+Float(duration.hourInMinutes())/Float((endOfTheDay-startOfTheDay)*60)
